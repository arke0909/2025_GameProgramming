...
std::vector<ItemInfo> AllItems = {
    ...
    { ItemType::Heal20HP,     L"20HP 회복",L"Recovery", L"그냥 회복", 60,5, nullptr},
    { ItemType::MultiShot,    L"멀티샷",STAT_MULTISHOT, L"2발 → 3발", 130,1, nullptr },
    { ItemType::SplashDamage, L"스플래쉬",STAT_SPLASH, L"범위 공격 증가", 140,1, nullptr },
    { ItemType::Pierce,       L"관통",STAT_PENET, L"관통 횟수 증가", 110,1, nullptr },
};
